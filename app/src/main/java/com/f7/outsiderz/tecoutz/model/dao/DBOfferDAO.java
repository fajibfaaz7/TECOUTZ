...
public class DBOfferDAO implements IOfferDAO {
    ...
    public long addOffer(Offer offer, long userId, String category) {
        ...
        values.put(mDb.SEMESTER, offer.getSemester());
    ...
    public Offer getOffer(long id) {
        ...
        /*    SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/YYYY");
            ...
            offer = new Offer(user, title, description, price, condition, category, semester, active, images, null);
            offer.setId(id);
    ...
    public ArrayList<Offer> getOffersByCategory(String category) {
        ...
        if(c.moveToFirst()){
            do {
                ...
                Offer offer = new Offer(user, title, description, price, condition, category, semester, active, images, creationDate);
                offer.setId(offerId);
                offers.add(offer);
            }
            while(c.moveToNext());
    ...
    public ArrayList<Offer> getOffers(String word){
        ...
        if(c.moveToFirst()){
            do {
                ...
                Offer offer = new Offer(user, title, description, price, condition, category, semester, active, images, null);
                offer.setId(offerId);
                offers.add(offer);
            }
            while(c.moveToNext());
